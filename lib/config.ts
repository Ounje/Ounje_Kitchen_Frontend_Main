...
export const ENDPOINTS = {
  ...
  ACCOUNTS: {
    ...
    FOOD_ITEM: (vendorId: string, itemId: string) =>
      `/api/accounts/vendors/${vendorId}/food-items/${itemId}`,
    FOOD_ITEM_TOGGLE: (vendorId: string, itemId: string) =>
      `/api/accounts/vendors/${vendorId}/food-items/${itemId}/toggle`,

    COMBOS: (vendorId: string) => `/api/accounts/vendors/${vendorId}/combos`,
    COMBO: (vendorId: string, comboId: string) =>
      `/api/accounts/vendors/${vendorId}/combos/${comboId}`,
    COMBO_TOGGLE: (vendorId: string, comboId: string) =>
      `/api/accounts/vendors/${vendorId}/combos/${comboId}/toggle`,
