...
export function PaymentSummary({ order }: PaymentSummaryProps) {
  ...
  const getMethodIcon = () => {
    ...
    if (method.includes("wallet") || method.includes("credit"))
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        <div className="p-5 rounded-xl border border-gray-100 dark:border-slate-700 bg-white dark:bg-slate-800 shadow-sm space-y-3">
          ...
          <div className="pt-3 mt-3 border-t border-gray-100 dark:border-slate-700">
            <p className="text-[10px] text-slate-500 dark:text-slate-400 uppercase font-bold tracking-widest mb-0.5">
              Reference ID
            </p>
        ...
        <div className="p-5 rounded-xl border border-gray-100 dark:border-slate-700 bg-white dark:bg-slate-800 shadow-sm space-y-3">
          ...
          <div className="space-y-2.5">
            <div className="flex justify-between items-center text-xs">
              ...
              <span className="text-slate-800 dark:text-slate-200 font-bold bg-slate-50 dark:bg-slate-700 px-2 py-0.5 rounded">
            ...
            {order.paymentConfirmedAt && (
              <div className="flex justify-between items-center text-xs">
                ...
                <span className="text-green-700 dark:text-green-400 font-bold bg-green-50 dark:bg-green-500/10 px-2 py-0.5 rounded">
            ...
            {order.refundedAt && (
              <div className="flex justify-between items-center text-xs">
                ...
                <span className="text-blue-700 dark:text-blue-400 font-bold bg-blue-50 dark:bg-blue-500/10 px-2 py-0.5 rounded">
