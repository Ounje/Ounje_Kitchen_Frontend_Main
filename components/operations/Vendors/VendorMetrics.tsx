      ...
      <div className="grid grid-cols-2 sm:grid-cols-4 gap-2.5">
        {metrics.map((m) => {
          ...
          return (
            <div
              key={m.label}
              className={`glass-card hover-lift p-4 flex items-center gap-4 ${m.border}`}
            >
              <div
                className={`w-10 h-10 rounded-xl flex items-center justify-center ${m.bg} ${m.color} shrink-0`}
              >
