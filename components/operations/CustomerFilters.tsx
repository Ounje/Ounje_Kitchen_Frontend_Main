    ...
    <div className="glass-card p-4 sm:p-5 mb-5 w-full">
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
        ...
        <div>
          ...
          <input type="text" value={filters.name} placeholder="Search by name…"
        ...
        <div>
          ...
          <input type="email" value={filters.email} placeholder="Search by email…"
        ...
        <div>
          ...
          <select value={filters.accountStatus} onChange={e => set("accountStatus", e.target.value)}
            title="Filter by status" aria-label="Filter by account status" className={inputCls}>
