          ...
          <form onSubmit={handleSubmit} className="space-y-3 pt-2">
            ...
            <div className="grid grid-cols-2 gap-3">
              <div className="space-y-1.5">
                ...
                <Input value={form.name} onChange={e => set("name", e.target.value)} placeholder="Owner name" />
              </div>
              <div className="space-y-1.5">
                <Label>
            ...
            <div className="space-y-1.5">
              <Label>Vendor / Brand Name <span className="text-red-500">*</span></Label>
              <Input value={form.vendorName} onChange={e => set("vendorName", e.target.value)} placeholder="e.g. Mama Nkechi Kitchen" />
            </div>
            <div className="space-y-1.5">
            ...
            <div className="grid grid-cols-2 gap-3">
              <div className="space-y-1.5">
                ...
                <Input value={form.storeName} onChange={e => set("storeName", e.target.value)} placeholder="Store name" />
              </div>
              <div className="space-y-1.5">
              ...
              <div className="space-y-1.5">
                <Label>NIN ID</Label>
                <Input value={form.ninID} onChange={e => set("ninID", e.target.value)} placeholder="NIN number" />
              </div>
              <div className="space-y-1.5">
                <Label>CAC Number</Label>
                <Input value={form.CACNumber} onChange={e => set("CACNumber", e.target.value)} placeholder="CAC reg number" />
              </div>
            </div>
            <div className="space-y-1.5">
              <Label>Services Offered <span className="text-xs text-gray-400">(comma-separated)</span></Label>
              <Input
            ...
            <div className="grid grid-cols-2 gap-3">
              <div className="space-y-1.5 col-span-2">
                ...
                <Input value={form.locationAddress} onChange={e => set("locationAddress", e.target.value)} placeholder="Store address" />
              </div>
              <div className="space-y-1.5">
                <Label>Latitude</Label>
                <Input value={form.latitude} onChange={e => set("latitude", e.target.value)} placeholder="6.4281" />
              </div>
              <div className="space-y-1.5">
                <Label>Longitude</Label>
                <Input value={form.longitude} onChange={e => set("longitude", e.target.value)} placeholder="3.4219" />
              </div>
              <div className="space-y-1.5 col-span-2">
                <Label>Zone</Label>
            ...
            <div className="grid grid-cols-2 gap-3">
              <div className="space-y-1.5">
                ...
                <Select value={form.fulfillmentType} onValueChange={v => set("fulfillmentType", v)}>
                  <SelectTrigger><SelectValue /></SelectTrigger>
                  <SelectContent>
                    {FULFILLMENT.map(f => <SelectItem key={f} value={f} className="capitalize">{f}</SelectItem>)}
                  </SelectContent>
                </Select>
              </div>
              <div className="space-y-1.5">
              ...
              <div className="space-y-1.5">
                ...
                <Select value={form.autoAcceptOrders} onValueChange={v => set("autoAcceptOrders", v)}>
                  <SelectTrigger><SelectValue /></SelectTrigger>
                  <SelectContent>
            ...
            <div className="grid grid-cols-2 gap-3">
              ...
              <div className="space-y-1.5">
                ...
                <Input value={form.bankName} onChange={e => set("bankName", e.target.value)} placeholder="e.g. Access Bank" />
              </div>
              <div className="space-y-1.5">
              ...
              <div className="space-y-1.5">
                ...
                <Input value={form.bankCode} onChange={e => set("bankCode", e.target.value)} placeholder="044" />
              </div>
            </div>
