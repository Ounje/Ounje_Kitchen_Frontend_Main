...
import {
  vendorService,
  type VendorFilters as FilterParams,
  type TopVendor,
...
export default function VendorsPage() {
  ...
  const handleSearch = (filterValues: FilterValues) => {
    const newFilters: FilterParams = {
      ...
      accountStatus: (filterValues.accountStatus || undefined) as
        | "active"
        | "suspended"
        | undefined,
      businessStatus: (filterValues.businessStatus || undefined) as
        | "registered"
        | "unregistered"
        | "pending"
        | undefined,
          ...
          <div>
            ...
            {pagination.total > 0 && (
              <p className="text-xs text-gray-400">
                {pagination.total.toLocaleString()} total vendors
              </p>
            )}
          </div>
        </div>
