    ...
    return (
      ...
      >
        <div className="text-center">
          <div
            className="animate-spin rounded-full h-12 w-12 border-b-2 mx-auto mb-4 border-[#1a3f1c]"
          />
      ...
      <div className="w-full px-4 sm:px-6 lg:px-8 xl:px-14 py-6">
        ...
        <div className="flex items-start justify-between mb-6">
          <div className="flex-1 min-w-0">
            <h1 className="text-2xl sm:text-3xl font-bold text-[#1a3f1c]">
              Document Upload
            </h1>
        ...
        <div className="bg-white rounded-xl p-4 sm:p-6 w-full">
          <h2 className="text-lg sm:text-xl font-bold mb-4 text-[#1a3f1c]">
            Rider's NIN
          </h2>
